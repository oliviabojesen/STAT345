...
p1 <- ggplot(salary_data_made, aes(x=locationX, y=locationY)) + # Plots shot location
      ...
      geom_point(aes(color = adjSalary), alpha = .7, size = .4) + # Color of points is the player's salary, adjusted for inflation
      scale_color_gradient(high = "#00471B", low = "#EEE1C8",
                           ...
                           labels=c("$10,000", "$20,000", "$30,000")) + # Changes legend labels to be reader friendly
      xlim(-250, 250) +
      ylim(-50, 420) +
...
p2 <- ggplot(salary_data_missed, aes(x=locationX, y=locationY)) + 
      ...
      geom_point(aes(color = adjSalary), alpha = .7, size = .4) +
      scale_color_gradient(high = "#00471B", low = "#EEE1C8",
